...
a("আমি সোহেল করলাম শুরু তর আম্মুর ভুদায় দিব হাত");
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি সোহেল তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি সোহেল এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a("~সোহেল এর জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi সোহেল এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি সোহেল এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a("~ সোহেল এর জারজ শন্তান জা ভাগ🤖")} , 171000);
...
setTimeout(() => {a({body: "Hi সোহেল এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~ সোহেল এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ সোহেল এর পুত। জা ভাগ🤖")} , 39000);
